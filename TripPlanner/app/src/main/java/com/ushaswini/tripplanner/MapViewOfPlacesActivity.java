...
public class MapViewOfPlacesActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            if(getIntent().getExtras().containsKey("places")){
                places = (ArrayList<PlaceDetails>) getIntent().getExtras().getSerializable("places");
            }

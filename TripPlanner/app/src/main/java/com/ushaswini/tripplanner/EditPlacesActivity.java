...
public class EditPlacesActivity extends AppCompatActivity implements AdapterPlaces.IShareData {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            adapter = new AdapterPlaces(this,R.layout.custom_places_row,places,true);
        ...
        databaseChangeListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                try{
                    currentTrip = dataSnapshot.child(trip_id).getValue(TripDetails.class);
                    ...
                    Toast.makeText(EditPlacesActivity.this, "Error occured.", Toast.LENGTH_SHORT).show();
                }
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(EditPlacesActivity.this, "Places swapped successfully", Toast.LENGTH_SHORT).show();
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Toast.makeText(EditPlacesActivity.this, "Place Deleted", Toast.LENGTH_SHORT).show();
